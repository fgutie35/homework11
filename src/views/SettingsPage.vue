...
<template>
    <form class="mx-auto mt-10 flex max-w-md flex-col gap-4 rounded-md bg-white p-8 shadow-lg" @submit.prevent="addEmployee">
        ...
        <input type = "text" placeholder="title" v-model="empUserTitle" class="rounded-md px-4 py-2 text-xl ring-1 ring-slate-300" />
        <input type = "text" placeholder="quote" v-model="empUserQuote" class="rounded-md px-4 py-2 text-xl ring-1 ring-slate-300" />                
